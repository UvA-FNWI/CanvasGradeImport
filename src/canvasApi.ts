...
export const getSubmissions = () =>
  getCollection<SubmissionGroup>(`${base}/courses/${courseId}/students/submissions?grouped=true&student_ids[]=all&response_fields[]=assignment_id&exclude_response_fields[]=preview_url&response_fields[]=grade&response_fields[]=excused`);
